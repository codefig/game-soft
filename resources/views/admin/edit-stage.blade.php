    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <hr>
                ...
                <form method="post" action="{{ route('admin.stage.edit.post', $stage->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class='form-control' id="timeframe" name="timeframe" value="{{ $stage->timeframe }}"/>
                </div>

                <div class='form-group'>
                    <label> Pass Value (Number of Questions) to Pass the Stage </label>
                    <input type="text" name="pass_value" id="pass_value" class="form-control" value="{{ $stage->pass_value }}"/>
                </div>
                ...
                <div class="form-group">
                        ...
                        <select  class="form-control" name="lap_id">
                            ...
                            @if(count($laps) > 0)
                                @foreach($laps as $lap)
                                <option {{ ($stage->lap_id == $lap->id) ? "selected": " " }} value="{{ $lap->id }}"> {{ $lap->name }} </option>
                                @endforeach
                            @endif
                ...
                <div class="form-group">
                        ...
                        <select  class="form-control" name="category_id">
                            ...
                            @if(count($categories) > 0)
                                ...
                                <option {{ ($stage->category_id == $category->id) ? "selected": " " }} value="{{ $category->id }}"> {{ $category->name }} </option>
                                @endforeach
                            @endif
