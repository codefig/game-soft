...
<body>
  ...
  <section class="dashboard">
    ...
    <div class="dashboard-content notifications">
        <div class="row">
            <div class="col-lg-12">
              <div class="custom-card">
                <h4 class="subject">Notification Title</h4>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. A impedit asperiores voluptatibus inventore iusto quidem
                  rem ipsum, dolor sit amet consectetur adipisicing elit. A impedit asperiores voluptatibus inventore
                </p>
              </div>
            </div>
          </div>
